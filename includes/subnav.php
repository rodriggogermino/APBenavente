    ...
    <?php
        if (isset($_SESSION['username'])) { ?>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="https://www.aebenavente.pt/" target="_blank">Adicionar notícias</a>
                    <a href="https://www.aebenavente.pt/" target="_blank">Remover notícias</a>
                    <a href="https://inovar.aebenavente.pt/inovarconsulta/app/index.html#/login" target="_blank">Adicionar ficheiros</a> 
                    <a href="https://inovar.aebenavente.pt/inovarconsulta/app/index.html#/login" target="_blank">Remover ficheiros</a>
                </div>
            </div>
        <?php } else { ?>
            <a href="">Inscrever-me</a>
